...
function generate_judging_texts(bt, is_alternative) {
    ...
    $.ajax('//battle.azurewebsites.net/api/material?round_id=' + btl_event.current_round_id + '&is_alternative=' + is_alternative, {
      type: 'GET',
      xhrFields: {
...
function handleSendClaimClick(event) {
  $.ajax('//battle.azurewebsites.net/api/log-record', {
    type: 'POST',
...
function send_text_to_battle() {
    ...
    $.ajax('//battle.azurewebsites.net/api/round/' + json_data.round_id + '/material-flow', {
      type: 'POST',
      contentType: 'application/json;charset=utf-8',
      cache: false,
      xhrFields: {
...
function get_rival_flow(comment_id, battle_type) {
    $.ajax('//battle.azurewebsites.net/api/bout-unit/' + comment_id + '/material-content/rival', {
      type: 'GET',
      xhrFields: {
          withCredentials: true
      },
...
function open_bout_unit(bout_unit_id, rtrn_values) {
    $.ajax('//battle.azurewebsites.net/api/boutunit/' + bout_unit_id, {
      type: 'POST',
      xhrFields: {
        withCredentials: true
      },
...
function set_is_page_show(is_page_show) {
    if (is_page_show !== null) {
      $.ajax('//battle.azurewebsites.net/api/user-info', {
        type: 'POST',
        xhrFields: {
          withCredentials: true
        },
...
function save_text_current_battle() {
    ...
    $.ajax('//battle.azurewebsites.net/api/round/' + btl_event.current_round_id + '/temp-flow', {
      type: 'POST',
      contentType: 'application/json;charset=utf-8',
      xhrFields: {
        withCredentials: true
...
function text_battle_creation() {
    ...
    $.ajax('//battle.azurewebsites.net/api/round/' + btl_event.current_round_id + '/current-item' , {
      type: 'GET',
      xhrFields: {
        withCredentials: true
      },
...
function judge_send_two_comments(battle_type, json_cm) {
    ...
    $.ajax('//battle.azurewebsites.net/api/judge-evaluation', {
      type: 'POST',
      contentType: 'application/json;charset=utf-8',
      xhrFields: {
        withCredentials: true
      ...
      data: JSON.stringify({
        ...
        function sendEvaluationNotification(tmpIdOfMaterial){
          $.ajax('//battle.azurewebsites.net/api/material/' + tmpIdOfMaterial + '/evaluation-notification', {
            type: 'GET',
            cache: false,
            xhrFields: {
              withCredentials: true
...
function ajaxRequest(mthd, jd, options) { // Ajax helper
    ...
    return $.ajax('//battle.azurewebsites.net' + requestUrl, ajaxOptions).always(function () {
        if (options.progress) {
            $('.spinner').hide();
        }
    });
...
function auth(login_options) {
    ...
    $.ajax({
        ...
        url: '//battle.azurewebsites.net/api/userprofile/',
...
function get_rating(round_id, battle_type, out_block) {
    $.ajax('//battle.azurewebsites.net/api/round/'+round_id + '/rating', {
      type: 'GET',
      cache: false
    }).done(function (r) {
        if (r) {
...
function get_flow(material_id, user_link, user_name, material_title, battle_type, out_div) {
    ...
    if (battle_type === "text_battle") {
        ...
        $(indiv).html(flow_div);
        $.ajax('//battle.azurewebsites.net/api/material/' + material_id + '/content', {
          xhrFields: {
            withCredentials: true
          },
          cache: true
                    ...
                    if (r[key].PricePlus === null) {
                        ...
                        $(pricePlusLink).addClass('link_view').html('оценить комментарий').on('click', { pricePlusCommentId: r[key].Id }, function (pricePlusEvent) {
                            ...
                            $(submitButton).html('Оценить комментарий').addClass('btn').on('click', function () {
                                ...
                                $.ajax('//battle.azurewebsites.net/api/bout-unit/'+ pricePlusEvent.data.pricePlusCommentId + '/price-plus', {
                                  type: 'POST',
                                  contentType: 'application/json;charset=utf-8',
                                  xhrFields: {
                                    withCredentials: true
...
function add_comment_to_material(comment_text, material_id, comment_sign, comments_div, reply_textarea, battle_type) {
    $.ajax('//battle.azurewebsites.net/api/material/' + material_id + '/comment', {
      type: 'POST',
      contentType: 'application/json;charset=utf-8',
      data: JSON.stringify({
...
function get_otbor_round_table(round_chislo, battle_type, battle_number) {
    $.ajax('//battle.azurewebsites.net/api/round-result', {
      type: 'GET',
      // Url params
      data: {
...
function save_nn() {
    ...
    $.ajax('//battle.azurewebsites.net/api/user-desc', {
      type: 'POST',
      contentType: 'application/json;charset=utf-8',
...
var zx = {
    get_materials_ocen_counters: function () {
        ...
        $.ajax('//battle.azurewebsites.net/api/material-scope/unopened', {
          xhrFields: {
             withCredentials: true
          },
          cache: false
    ...
    get_materials: function (in_mtype) {
        ...
        $.ajax('//battle.azurewebsites.net/api/material', {
          data: {
    ...
    get_referrer_users: function () {
        $.ajax('//battle.azurewebsites.net/api/referrer-users', {
           xhrFields: {
             withCredentials: true
           }
        }).done(function (r) {
...
function coin_transfer(recipient_username, coin_sum, msg) {
    ...
    $.ajax('//battle.azurewebsites.net/api/coin-transfer', {
              type: 'POST',
              contentType: 'application/json;charset=utf-8',
